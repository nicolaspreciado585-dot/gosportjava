...
public class ReservaController {
    ...
    // CREAR RESERVA
    // ====================================
    // REEMPLAZAR EL MÉTODO crearReserva() EN ReservaController.java
...
public String crearReserva(
    ...
    try {
        ...
        // ⭐ CAMBIO: La reserva queda PENDIENTE hasta que se pague
        ...
        // ⭐ NUEVO: Redirigir directamente al proceso de pago
        redirectAttributes.addFlashAttribute("successMessage",
            "¡Reserva creada! Ahora procede con el pago para confirmarla.");
        return "redirect:/pagos/metodo/" + reservaGuardada.getId();
